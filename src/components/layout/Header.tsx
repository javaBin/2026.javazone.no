        ...
        <div className="fixed top-0 z-50 w-screen">
            ...
            <div className="relative flex p-4">
                <div className="flex px-2 mx-auto sm:mx-0">
                    <a className="btn-ghost font-semibold text-md md:text-xl py-2 px-3 md:px-4 rounded-3xl transition-transform transition-opacity duration-200 hover:opacity-90"
                       href={"/"}>
                        Info
                    </a>
                    <a className="btn-ghost font-semibold text-md md:text-xl py-2 px-3 md:px-4 rounded-3xl transition-transform transition-opacity duration-200 hover:opacity-90"
