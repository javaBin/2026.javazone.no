...
const InfoPage = () => {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen p-8 pt-20 mb-20 space-y-8">
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        <Heading level="h2">JavaZone venue</Heading>
        <p>
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        <Heading level="h2">Public transportation</Heading>
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        ...
        <ul className="list-disc pl-6 space-y-1">
          <li>NOK 75/hour, max NOK 438/24h</li>
        </ul>
        <h3 className="text-lg font-semibold">Vehicles &gt; 3,500 kg</h3>
        <ul className="list-disc pl-6 space-y-1">
          <li>NOK 150/hour, max NOK 856/24h</li>
        </ul>
        <ul className="list-disc pl-6 space-y-1">
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        <Heading level="h2">Weather</Heading>
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        ...
        <ul className="list-disc pl-6 space-y-1">
          ...
          <li>Bars close: 23:30</li>
          <li>Doors close: midnight</li>
        </ul>
      </section>
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        <Heading level="h2">Social media</Heading>
        <p>
      ...
      <section className="w-full max-w-2xl space-y-4 text-left">
        <Heading level="h2">More info</Heading>
        <p>
