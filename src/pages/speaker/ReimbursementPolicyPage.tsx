    ...
    <div className="min-h-screen flex justify-center p-8 pt-20 relative z-0">
      <div className="max-w-2xl text-center space-y-12">
        ...
        <div className="text-left space-y-4">
          ...
          <p>
            Applications for speaker reimbursements must be submitted before <strong>August 1st, 2026</strong>.
          </p>
        </div>
        ...
        <div className="text-left space-y-4">
          ...
          <p>In this mail, provide an estimate of your travel expenses and the days you will be visiting Oslo during the conference.</p>
          <p>
        ...
        <div className="text-left space-y-4">
          ...
          <p>
            ...
            and are only accepted prior to our conference. Reimbursements are provided after the conference. For this, we require you to send us
            copies of all receipts, the name of your bank and international account numbers (IBAN, BIC/SWIFT, if available). We reserve the right to
