    ...
    <div className="min-h-screen flex justify-center p-8 pt-20 relative z-0">
      <div className="max-w-2xl text-center space-y-12">
        ...
        <div className="text-left space-y-4">
          ...
          <p>
            Family tickets are available <strong>only</strong> to speakers who have had <strong>a full presentation or a workshop accepted</strong>{' '}
            for JavaZone. Lightning talk speakers are not included in this scheme.
          </p>
          <p>
        ...
        <div className="text-left space-y-4">
          ...
          <div className="space-y-6 mt-6">
            <section className="rounded-lg border border-base-300 p-6 bg-base-100">
              <h3 className="text-2xl font-bold">1. Short visit family pass (free)</h3>
            ...
            <section className="rounded-lg border border-base-300 p-6 bg-base-100">
              <h3 className="text-2xl font-bold">2. Full conference family ticket (50% discount)</h3>
              <p className="mt-4">
        ...
        <div className="text-left space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              Family tickets are offered <strong>subject to capacity</strong>. We reserve the right to decline or adjust requests if needed to keep
              the conference logistics manageable.
            </li>
            <li>
