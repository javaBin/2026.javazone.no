  ...
  return (
    <div className="min-h-screen flex justify-center p-8 pt-20 relative z-0">
      <div className="max-w-2xl text-center space-y-12">
        ...
        <div className="text-left space-y-4">
          <h2 className="text-3xl font-bold mb-6">What is it like speaking at JavaZone?</h2>
          ...
          <p>
            We can brag as much as we want, but JavaZone would be nothing without all the great speakers! That's why we need your help to make sure
            that JavaZone 2026 will be at least as awesome as the earlier events. If you think you have something interesting to share, please submit
            your talk or workshop.
          </p>

          <p>
            JavaZone is committed to diversity, and we are especially interested in quality submissions from groups that are under-represented in
        ...
        <div className="text-left space-y-4">
          ...
          <p>
            You should think about which format your talk will work best in. Are you presenting a new idea, or do you require more time to elaborate
            on your subject? How hands-on do you want to be? We have three formats you can present your material in.
          </p>

          <div className="space-y-6 mt-6">
            <section className="rounded-lg border border-base-300 p-6 bg-base-100">
              <h3 className="text-2xl font-bold">Lightning talks (10 or 20 minutes)</h3>
              <p className="mt-4">
            ...
            <section className="rounded-lg border border-base-300 p-6 bg-base-100">
              <h3 className="text-2xl font-bold">Presentations (45 or 60 minutes)</h3>
              <p className="mt-4">
            ...
            <section className="rounded-lg border border-base-300 p-6 bg-base-100">
              <h3 className="text-2xl font-bold">Workshops (2 hours, 4 hours, 8 hours)</h3>
              <p className="mt-4">
        ...
        <div className="text-left space-y-4">
          ...
          <p>
            ...
            way from Oslo airport to Oslo city center. For those based in Oslo, Lillestrøm is just 10 minutes away, with very frequent train
            departures.
          </p>
        </div>
        ...
        <div className="text-left space-y-4">
          ...
          <div className="space-y-6">
            <section className="rounded-lg border border-base-300 p-6 bg-base-100">
              <h3 className="text-2xl font-bold">Accepted presentations, lightning talks, and workshops</h3>
              <p className="mt-4">
              ...
              <p className="mt-4">
                All accepted speakers can apply to join us at JourneyZone, our famous speakers' tour into the Norwegian wilderness. More details will
                be available soon.
              </p>
            </section>
