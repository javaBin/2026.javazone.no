    ...
    <div className="flex items-center justify-center flex-1 mt-14 text-base-content">
      ...
      <div className="z-40 p-4 max-w-7xl">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <LinkButton title="Buy tickets" size="large" variant="pop" link="/tickets" className="mt-6 max-w-md min-w-[320px]" />
          <LinkButton
          ...
          />
          <LinkButton title="Become a volunteer" size="large" variant="pop-outline" link="/volunteer" className="mt-3 max-w-md min-w-[320px]" />
        </div>
      </div>
    </div>
  )
