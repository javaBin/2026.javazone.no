...
const PartnerPage = () => {
  return (
      <div className="min-h-screen flex flex-col items-center justify-center p-8 pt-20 relative space-y-30">
          <Heading level="h1" className="mb-20">JavaZone 2026 partner</Heading>

          <div className="max-w-2xl text-left space-y-4 mb-8">
              <Heading level="h2" className="mb-6">Partner registration is open</Heading>
              <p>
                  You need to decide what type of stand you want when registering.
                  The formal contract and invoice will be sent to you later.
              ...
              <Heading level="h3" className="mb-4">Watch the recording here</Heading>
              <div className="w-full overflow-hidden rounded-lg bg-black"> {/*todo: does this need 2 div?*/}
              ...
              <div className="text-left mt-12">
                  <Heading level="h2" className="mb-6">Packages and tickets</Heading>
                  <Packages wave={false}/>
              </div>
          </div>
          ...
          <div className="max-w-2xl w-full mb-24">
              ...
              <p>If you have any questions or concerns, please reach out to us at{" "}
